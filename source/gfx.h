...
// measure the pixel width a string would occupy at the given pixel size
// (the engine's funcFontWidth upcall). returns 0 on failure.
int gfx_measure_text_width(const char *text, int size);
